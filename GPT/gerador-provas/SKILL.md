...
- As questoes elaboradas devem ser baseadas em pesquisa em fontes.md com SearchGPT, caso contrário serão consideradas inválidas. 
...
Passo 1 → Qual a disciplina?
  (Ex: Contabilidade Geral, Direito Administrativo, Direito Tributário, Português, Raciocínio Lógico, etc.)

Passo 2 → Qual o tópico específico?
  (ex: Direito Reais, Controle de Constitucionalidade, LDO, Licitações, CPC 01, etc.)
...
- Fundamentar todo gabarito em fontes.md
...
### Nunca fazer:
- Questões sem pesquisa em fontes.md
