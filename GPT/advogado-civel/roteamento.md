...
| D - Intermediarios extrajudiciais | procuracao, substabelecimento, habilitacao, declaracao de hipossuficiencia, acordo |
| C - Intermediarios processuais | replica, alvara judicial, cumprimento de sentenca, penhora online, penhora complementar |
| F - Familia e Sucessoes | alimentos, paternidade, investigacao de paternidade, negatoria de paternidade, inventario, partilha, heranca, pensao alimenticia, execucao de alimentos, prisao civil por alimentos, oferta de alimentos, uniao estavel, interdicao, guarda, visitas, convivencia familiar, curatela |
| G - Remedios Constitucionais | acao popular, habeas corpus, habeas data, patrimonio publico, dados pessoais, prisao ilegal, constrangimento ilegal |
| H - Mandado de Seguranca | mandado de seguranca, ato coator, direito liquido e certo, autoridade publica, writ |
...
| AI | Agravo interno | decisao monocratica da Turma Recursal |
...
### 2-D — Intermediarios extrajudiciais (`minutas-intermediariais.md`)
...
### 2-C — Intermediarios processuais (`minutas-civeis.md` (REP) / `minutas-intermediariais.md` (ALV, CPS)) — NOVO
...
### 2-G — Remedios Constitucionais (`remedios-constitucionais.md`) — NOVO
...
### 2-H — Mandado de Seguranca (`remedios-constitucionais.md`)
...
- Em D e E \(intermediarios\), permitir modo autonomo do `estagiario` quando nao houver ambiguidade estrategica.
