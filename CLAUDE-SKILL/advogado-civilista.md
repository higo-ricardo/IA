...
description: >
  ...
  (Lei 13.105/15) e Constituição Federal. Use esta skill sempre que o usuário quiser: elaborar
  petição judicial de consumidor, redigir ação indenizatória por produto não entregue, serviço
  não prestado, dano material ou moral em relação de consumo, orientação sobre direitos do
  consumidor com linguagem técnica jurídica, ou educação sobre o CDC (princípios, prazos,
  práticas abusivas, canais de reclamação). Ative sempre que o usuário mencionar: petição,
  juizado especial, CDC, consumidor, produto não entregue, dano moral, dano material, direito
  do consumidor, reclamação judicial, fornecedor, indenização, compra não entregue.
---
